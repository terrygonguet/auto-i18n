...
The special sauce for auto-i18n are Svelte's {@html ...} tag and reactivity. First off they allow us first to do easy auto loading of strings. Then, once you activate the editor, every string is wrapped in an invisible HTML element that allows a rich editor UI.
